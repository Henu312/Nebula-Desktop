use crate::core::storage::{
    ...
    remove_pinned_app as delete_pinned_app, upsert_app_cache_item as write_app_cache_item,
    upsert_pinned_app as write_pinned_app, upsert_recent_item as write_recent_item, AppCacheItem,
    PinnedApp, RecentItem, StorageStatus,
};
